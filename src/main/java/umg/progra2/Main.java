...
public class Main {
    ...
    */
    ...
    private static void PruebaInsertaUsuario() {
        ...
        user.setNombre("Lupillo Rivera");
        user.setCorreo("LRivera@gmail.com");
        user.setSeccion("A");
    ...
    private static void PruebaActualizacionUsuario() {
        ...
        try {
            usurioObtenido = servicioUsuaio.getUserByEmail("LRivera@gmail.com");
    ...
    private static void PruebaEliminarUsuario() {
        UserService servicioUsuaio = new UserService();
        try {
            servicioUsuaio.deleteUserBycarne("0905-12-12345");
    ...
    public static void main(String[] args) {
        ...
        //===================================================================================
        //Tarea de pregunton y guardar preguntas.
        ...
        try{
            ...
            BotCuestionario boto = new BotCuestionario();
        ...
        try{
            ...
            BotPregunton bottt = new BotPregunton();
            botsApi.registerBot(bottt);
        ...
        */
        ...
        try{
            ...
            BotRegistra bott = new BotRegistra();
