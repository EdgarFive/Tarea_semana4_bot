...
public class BotPregunton extends TelegramLongPollingBot {
    ...
    public BotPregunton() {
        ...
        preguntas.put("SECTION_4", new String[]{"4.1- Tienes hambre?", "4.2- Tienes sueño?", "4.3- Te gustan las galletas?", "4.4- Que tal la clase?","4.5- Como vas en el semestre?", "4.6- Te gusta el café?"});
    }
